"""Replace light-blue / blue-gray background in lec02 PNGs with white.

Cách dùng:
    .conda/bin/python 2526-2/img/lec02/scripts/recolor_bg_to_white.py

Logic:
1. Quét mọi `*.png` trong `2526-2/img/lec02/` (bỏ qua thư mục `scripts/`).
