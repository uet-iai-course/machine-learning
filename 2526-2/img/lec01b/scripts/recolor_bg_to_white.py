"""Replace light-blue / blue-gray background in lec01b PNGs with white.

Cách dùng:
    .conda/bin/python 2526-2/img/lec01b/scripts/recolor_bg_to_white.py

Logic:
1. Quét mọi `*.png` trong `2526-2/img/lec01b/` (bỏ qua thư mục `scripts/`).
...
def is_light_bluish(rgb: np.ndarray) -> bool:
    ...
    """
    r, g, b = rgb
    if not (210 <= r <= 252 and 210 <= g <= 252 and 210 <= b <= 252):
        return False
